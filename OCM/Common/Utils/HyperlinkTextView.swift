...
class HyperlinkTextView: UITextView {
    ...
    init(htmlText: String) {
        ...
        guard let styledAttributedText = NSMutableAttributedString(fromHTML: htmlText, pointSize: 16, color: .black)  else { logWarn("NSMutableAttributedString is nil"); return }
