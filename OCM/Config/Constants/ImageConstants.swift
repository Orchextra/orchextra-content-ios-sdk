...
extension UIImage {
    struct OCM {
        ...
        static let loading = UIImage(named: "loading", in: Bundle.OCMBundle(), compatibleWith:nil)
        static let info = UIImage(named: "info", in: Bundle.OCMBundle(), compatibleWith:nil)
    }
}
